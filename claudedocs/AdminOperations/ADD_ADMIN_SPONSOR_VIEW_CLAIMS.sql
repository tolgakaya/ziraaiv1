...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM "OperationClaims" WHERE "Id" = 133) THEN
        ...
        VALUES (133, 'GetSponsorAnalysesAsAdminQuery', 'Admin Sponsor Analyses View', 'Admin olarak sponsor analizlerini görüntüleme');
    ...
    IF NOT EXISTS (SELECT 1 FROM "OperationClaims" WHERE "Id" = 134) THEN
        INSERT INTO "OperationClaims" ("Id", "Name", "Alias", "Description")
        VALUES (134, 'GetSponsorAnalysisDetailAsAdminQuery', 'Admin Sponsor Analysis Detail View', 'Admin olarak sponsor analiz detayı görüntüleme');
    ...
    IF NOT EXISTS (SELECT 1 FROM "OperationClaims" WHERE "Id" = 135) THEN
        INSERT INTO "OperationClaims" ("Id", "Name", "Alias", "Description")
        VALUES (135, 'GetSponsorMessagesAsAdminQuery', 'Admin Sponsor Messages View', 'Admin olarak sponsor mesajlarını görüntüleme');
    ...
    IF NOT EXISTS (SELECT 1 FROM "OperationClaims" WHERE "Id" = 136) THEN
        INSERT INTO "OperationClaims" ("Id", "Name", "Alias", "Description")
        VALUES (136, 'GetNonSponsoredAnalysesQuery', 'Admin Non-Sponsored Analyses View', 'Admin olarak sponsorsuz analizleri görüntüleme');
    ...
    IF NOT EXISTS (SELECT 1 FROM "OperationClaims" WHERE "Id" = 137) THEN
        INSERT INTO "OperationClaims" ("Id", "Name", "Alias", "Description")
        VALUES (137, 'GetNonSponsoredFarmerDetailQuery', 'Admin Non-Sponsored Farmer Detail', 'Admin olarak sponsorsuz çiftçi detayı görüntüleme');
    ...
    IF NOT EXISTS (SELECT 1 FROM "OperationClaims" WHERE "Id" = 138) THEN
        INSERT INTO "OperationClaims" ("Id", "Name", "Alias", "Description")
        VALUES (138, 'GetSponsorshipComparisonAnalyticsQuery', 'Admin Sponsorship Comparison Analytics', 'Admin sponsor karşılaştırma analitiği görüntüleme');
    ...
    -- Claim 139: SendMessageAsSponsor (Fix if wrong data exists)
    IF EXISTS (SELECT 1 FROM "OperationClaims" WHERE "Id" = 139 AND "Name" != 'SendMessageAsSponsorCommand') THEN
        UPDATE "OperationClaims"
        SET "Name" = 'SendMessageAsSponsorCommand',
            "Alias" = 'Admin Send Message As Sponsor',
            "Description" = 'Admin olarak sponsor adına mesaj gönderme'
        WHERE "Id" = 139;
        RAISE NOTICE 'Claim 139 updated from wrong data to SendMessageAsSponsorCommand';
    ELSIF NOT EXISTS (SELECT 1 FROM "OperationClaims" WHERE "Id" = 139) THEN
        INSERT INTO "OperationClaims" ("Id", "Name", "Alias", "Description")
        VALUES (139, 'SendMessageAsSponsorCommand', 'Admin Send Message As Sponsor', 'Admin olarak sponsor adına mesaj gönderme');
        RAISE NOTICE 'Claim 139 (SendMessageAsSponsorCommand) added successfully';
    ELSE
        RAISE NOTICE 'Claim 139 already exists with correct data, skipping';
    END IF;
END $$;
