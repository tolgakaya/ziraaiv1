        ...
        public class GetSponsorProfileQueryHandler : IRequestHandler<GetSponsorProfileQuery, IDataResult<SponsorProfileDto>>
        {
            ...
            public async Task<IDataResult<SponsorProfileDto>> Handle(GetSponsorProfileQuery request, CancellationToken cancellationToken)
            {
                ...
                var profileDto = new SponsorProfileDto
                {
                    ...
                    VisibilityLevel = sponsorProfile.VisibilityLevel,
                    DataAccessLevel = sponsorProfile.DataAccessLevel,
                    HasMessaging = sponsorProfile.HasMessaging,
                    HasSmartLinking = sponsorProfile.HasSmartLinking,
                    IsVerified = sponsorProfile.IsVerified,
                    IsActive = sponsorProfile.IsActive,
                    TotalSponsored = sponsorProfile.TotalSponsored,
                    ActiveSponsored = sponsorProfile.ActiveSponsored,
